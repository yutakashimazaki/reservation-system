...
(function scopeWrapper($) {
    ...
    function register(email, password, name, address, phoneNumber, onSuccess, onFailure) {
        var dataEmail = {
            Name: 'email',
            Value: email
        };
        ...
        var attributePhoneNum = new AmazonCognitoIdentity.CognitoUserAttribute(dataPhoneNum);
    ...
    function handleSignin(event) {
        ...
        signin(email, password,
            function signinSuccess() {
                ...
                window.location.href = '/confirm/space-a';
            },
    ...
    function handleRegister(event) {
        ...
        var confirmPass = $('#confirmPassInputRegister').val();
        var name = $('#nameInputRegister').val();
        var address = $('#addressInputRegister').val();
        var phoneNumber = $('#phoneNumInputRegister').val();
        ...
        if (password === confirmPass) {
            register(email, password, name, address, phoneNumber, onSuccess, onFailure);
        } else {
